...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <NavbarContent
        justify="end"
        className="flex-1 flex items-center -space-x-4 sm:-space-x-3 ml-5"
      >
        <NavbarItem>
        ...
        <NavbarItem>
          <Button
            ...
            isIconOnly
            variant="light"
            className="relative overflow-visible mr-0 lg:mr-2"
          >
            {cartValue > 0 ? (
              <div className="absolute text-white bg-primary -top-1 right-0 text-[10px] w-[16px] h-[16px] flex items-center justify-center rounded-full font-semibold">
                {cartValue}
              </div>
            ) : null}
